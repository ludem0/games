...
export function getDefaultRoundLayouts(): RoundLayout[] {
  return [
    ...
    round(1,
      ...
      [{ color: PURPLE, side: 'south', tracks: [0, 1], anchor: 0 , y:400},   // A↔B
       { color: PURPLE, side: 'south', tracks: [2, 3], anchor: 2 , y:400}]), // C↔floating
    ...
    round(2,
      ...
      [{ color: PURPLE, side: 'south', tracks: [0, 1], anchor: 0 },
       { color: PURPLE, side: 'south', tracks: [1, 0], anchor: 1 },
