...
export async function POST(
  ...
  const MAIN_GAMES = ['track_trouble', 'double_team', 'kings_court', 'elevator_race', 'puzzle_chambers', 'modular_rooms', 'locked_out', 'the_cube', 'possession'] as const
  ...
  const GAME_NAMES = {
    ...
    possession: 'Five Fold Possession',
  }
