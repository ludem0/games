...
import { getGame, viewFor } from '@/lib/puzzleChambers'
import { getParticipants } from '@/lib/seasons'
import ChambersClient from './ChambersClient'

export default async function ChambersPage({ params }: { params: Promise<{ slug: string }> }) {
