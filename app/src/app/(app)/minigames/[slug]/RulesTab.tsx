  ...
  return (
    <div className={styles.rulesWrap}>
      ...
      <section className={styles.rulesSection}>
        ...
        <p>Пересекать пропасть не обязательно. Если вы дёргали рычаг, или ваша связка не набрала нужное число людей, или вы вообще не подали заявку, то во второй фазе вы всё ещё на южной стороне.</p>
      ...
      <section className={styles.rulesSection}>
        ...
        <p>Каждый раз, когда ваш счёт достигает <strong>числа, кратного 10</strong>, вы получаете <strong>1 псигем</strong>. Начисление считается после каждой фазы.</p>
        <p className={styles.rulesExample}>
          Пример: у вас 8 очков. В первой фазе заработали 2, стало 10, получили псигем. Во второй заработали ещё 3, стало 13. Следующий псигем будет на 20 очках.
        </p>
