          ...
          <div className={styles.groupHeader}>
            ...
            {isAdmin && (
              <>
                ...
                <button className={styles.addBtn} onClick={() => addMatch('main', 'labyrinth')}>+ Labyrinth</button>
              </>
            )}
          </div>
          ...
          <div className={styles.groupHeader}>
            ...
            {isAdmin && (
              <>
                ...
                <button className={styles.addBtn} onClick={() => addMatch('death', 'domain')}>+ Domain</button>
              </>
            )}
          </div>
